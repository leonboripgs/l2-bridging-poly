...
contract MediatorSOPv1 is IERC721Receiver, Ownable {
    ...
    function finishBridgeToL2(address sender, uint256 tokenId, uint8 level, bool active, uint64 cdPlay, uint64 cdFeed, uint64 cdClean, uint64 cdTrain, uint64 cdDaycare)
